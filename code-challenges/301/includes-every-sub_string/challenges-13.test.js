...
describe('Testing challenge 2', () => {
  test.skip('It should return only the strings that contain smiley faces', () => {
...
describe('Testing challenge 3', () => {
  test.skip('It should return a standardized set of phone numbers', () => {
...
describe('Testing challenge 4', () => {
  test.skip('It should only return the odd indexed characters from the string', () => {
...
describe('Testing challenge 5', () => {
  test.skip('It should correctly assess whether all the strings are happy', () => {
    const words = ['things', 'apple (:)', ':)banana', 'missing that thing', 'cant:)aloupe'];
