...
const count = (target, input) => {
  return target.reduce(acc => acc == input).length;
};
...
describe('Testing challenge 2', () => {
  test.skip('It should add all the numbers in the arrays', () => {
...
describe('Testing challenge 3', () => {
  test.skip('It should return numbers divisible by five, then raise two to the power of the resulting numbers', () => {
