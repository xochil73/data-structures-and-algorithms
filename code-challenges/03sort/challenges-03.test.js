...
//used a method I found on sitepoint.com ("sophisticated sorting in JavaScrit")
...
const sortNumbersByLength = (arr) => {
  arr.sort((a, b) => {
    let x = a.toString().length, y = b.toString().length
    return  x < y ? -1 : x > y ? 1 : 0;
  });
  return arr;
};
...
const sortPeopleBetter = (arr) => {
  arr.sort((a, b) => {
    let u = a.firstName, v = b.firstName;
    let w = a.lastName, x = b.lastName;
    let y = a.age, z = b.age;
